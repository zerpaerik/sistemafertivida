        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" action="consultas/update">
					{{ csrf_field() }}                
                    <div class="card-body">
                    <div class="row">
                    <div class="col-md-3">
                   ...
                   <div class="col-md-3">
                      <label>Especialista</label>
                        <select class="form-control" name="especialista">
                         @foreach($prof as $p)
                         @if($consulta->id_especialista == $p->id)
                                <option value="{{$p->id}}" selected="selected">{{$p->lastname}} {{$p->name}}</option>
                                @else
                      ...
                      <label>Paciente Mujer</label>
                        <select class="form-control" name="pacientem">
                         @foreach($pacientesm as $pm)
                              @if($consulta->id_paciente_mujer == $pm->id)
                      ...
                      <label>Paciente Hombre</label>
                        <select class="form-control" name="pacienteh">
                         @foreach($pacientesh as $ph)
                              ...
                              @if($consulta->id_paciente_hombre == $ph->id)
