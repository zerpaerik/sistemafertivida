        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Crear Documentos</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    @include('flash-message')
      ...
      <div class="card">
              <div class="card-header">
                  ...
                  <form role="form" method="post" action="documentos/create" enctype="multipart/form-data">
                  {{ csrf_field() }}  	
              ...
              <div class="row" style="margin-left:10px;margin-right:10px;">
              <div class="col-md-4">
                    <label for="exampleInputEmail1">Adjunte</label>
                    <input type="file"  class="form-control" id="nombre" name="documento" placeholder="Nombre">
                  </div>
                  <div class="col-md-4">
                    <label for="exampleInputEmail1">Adjunte</label>
                    <input type="file"  class="form-control" id="nombre" name="documento1" placeholder="Nombre">
                  </div>
                  <div class="col-md-4">
                    <label for="exampleInputEmail1">Adjunte</label>
                    <input type="file"  class="form-control" id="nombre" name="documento2" placeholder="Nombre">
                  </div>
              ...
              <div class="col-md-4">
                    <label for="exampleInputEmail1">Adjunte</label>
                    <input type="file"  class="form-control" id="nombre" name="documento3" placeholder="Nombre">
                  </div>
                  <div class="col-md-4">
                    <label for="exampleInputEmail1">Adjunte</label>
                    <input type="file"  class="form-control" id="nombre" name="documento4" placeholder="Nombre">
                  </div>
