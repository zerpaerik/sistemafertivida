  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Editar Orden</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            @if($item != null)
            <label for="exampleInputEmail1">Lista de servicios en orden</label>
            <br>
            ...
            <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{$p->servicio}}</td>
                    <td>
                    <a class="btn btn-primary btn-sm" href="ordenes-item-edit-{{$p->id}}">
                              <i class="fas fa-edit">
                              </i>
                              Editar
                          </a>
                          <a class="btn btn-danger btn-sm" href="ordenes-item-delete-{{$p->id}}" onclick="return confirm('¿Desea Eliminar este registro?')">
            ...
            @if($iteml != null)
            <label for="exampleInputEmail1">Lista de laboratorios en orden</label>
            <br>
            ...
            <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{$pl->analisis}}</td>
                    <td>
                    <a class="btn btn-primary btn-sm" href="ordenes-iteml-edit-{{$pl->id}}">
                              <i class="fas fa-edit">
                              </i>
                              Editar
                          </a>
                          <a class="btn btn-danger btn-sm" href="ordenes-iteml-delete-{{$pl->id}}" onclick="return confirm('¿Desea Eliminar este registro?')">
                              <i class="fas fa-trash">
                              </i>
                              Eliminar
                          </a>
